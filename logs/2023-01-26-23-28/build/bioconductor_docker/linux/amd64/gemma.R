...
also installing the dependencies ‘zlibbioc’, ‘bitops’, ‘matrixStats’, ‘XVector’, ‘RCurl’, ‘GenomeInfoDbData’, ‘generics’, ‘timechange’, ‘MatrixGenerics’, ‘GenomicRanges’, ‘BiocGenerics’, ‘IRanges’, ‘GenomeInfoDb’, ‘DelayedArray’, ‘dplyr’, ‘tidyselect’, ‘vctrs’, ‘bit’, ‘data.table’, ‘lubridate’, ‘SummarizedExperiment’, ‘Biobase’, ‘tidyr’, ‘S4Vectors’, ‘bit64’
...
trying URL 'https://packagemanager.posit.co/cran/__linux__/jammy/latest/src/contrib/vctrs_0.5.2.tar.gz'
Content type 'binary/octet-stream' length 1282129 bytes (1.2 MB)
==================================================
downloaded 1.2 MB
...
* ‘vctrs’ was already a binary package and will not be rebuilt
* creating tarball
packaged installation of ‘vctrs’ as ‘vctrs_0.5.2_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (vctrs)
...
** testing if installed package keeps a record of temporary installation path
* creating tarball
packaged installation of ‘MatrixGenerics’ as ‘MatrixGenerics_1.10.0_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (MatrixGenerics)
...
The downloaded source packages are in
	‘/tmp/RtmpyS4siF/downloaded_packages’
